...
export class HerbistComponent implements OnInit, OnDestroy {
  ...
  parallaxUrl = environment.cloudinary ? environment.cloudinaryURL + ',w_800/' + environment.cloudinaryId + '/assets/images/parallax/pot.webp' : '/assets/images/parallax/pot.webp';
